...
net = cv.dnn.readNet("./models/YOLO/yolov3_training_last.weights", "./models/YOLO/yolov3_training.cfg")
...
classification_model = Helper.loadModel('./models/YOLO/traffic.h5') #load mask detection model
    ...
    for j in range(len(boxes)):
        if j in indexes:
            ...
            if len(crop_img) >0:
                ...
                class_id = np.argmax(classification_model.predict(crop_img))+1
                label = str(Helper.getClassName(class_id))
